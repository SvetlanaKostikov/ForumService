...
import telran.forum.dto.DatePeriodDto;
	...
	public class ForumServiceImpl implements ForumService {
		...
		public Post addNewPost(NewPostDto newPost,String login) {
			Post post = convertToPost(newPost,login);
			repository.save(post);
			return post;
		}

		private Post convertToPost(NewPostDto newPost,String login) {
			return new Post(newPost.getTitle(), newPost.getContent(), login, newPost.getTags());
		}
		...
		@Override
		public Post updatePost(PostUpdateDto updatePost,String login) {//TODO
